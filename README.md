...
Or it possible to provide path to file containing customers:
```
$ ruby ./main.rb /path/to/file/cusomers.txt
```

Web service provides single page that contains form where center coordinates and radius can be specified.
